...
This workflow publishes Zemeckis to Maven Central using the split release scripts in this directory. Run commands
...
The package command writes `dist/zemeckis-<version>/` and `dist/zemeckis-<version>.zip`.
