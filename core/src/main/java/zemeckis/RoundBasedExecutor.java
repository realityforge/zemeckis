 ...
 */
abstract class RoundBasedExecutor extends AbstractExecutor {
    ...
    void onRunawayTasksDetected() {
        final List<String> taskNames = Zemeckis.shouldCheckInvariants() && BrainCheckConfig.verboseErrorMessages()
